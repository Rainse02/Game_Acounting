...
// Release signing: create android/key.properties (see key.properties.example)
// with your keystore details. When the file is absent, release builds fall
// back to the debug key so local `flutter build` keeps working.
...
android {
    ...
    defaultConfig {
        // Keep this ID: changing it makes existing installs unable to upgrade.
    ...
    buildTypes {
        release {
            // R8 shrinking + resource shrinking keep the APK small.
